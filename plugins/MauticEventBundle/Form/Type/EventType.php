...
class EventType extends AbstractType
{
    ...
    {
        $cleaningRules                 = $this->getFormFields($builder, $options, 'event');
        $cleaningRules['eventemail'] = 'email';
        ...
        $builder->add(
            $builder->create(
                ...
                UserListType::class,
                [
                    'label'      => 'mautic.lead.event.field.owner',
                ...
                'post_extra_buttons' => [
                    [
                        ...
                        'attr'  => [
                            ...
                            'data-header' => $this->translator->trans('mautic.lead.event.header.merge'),
