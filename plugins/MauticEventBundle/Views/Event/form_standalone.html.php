...
$header = ($entity->getId())
    ...
    $view['translator']->trans(
        'mautic.event.menu.edit',
        ['%name%' => $view->escape($entity->getName())]
    )
    :
    $view['translator']->trans('mautic.event.menu.new');
...
?>
    ...
    echo ' active';
                                ...
                                <a href="#event-<?php echo $g; ?>" class="steps" data-toggle="tab">
        ...
        <div class="col-md-9 bg-auto height-auto bdr-l">
            <div class="tab-content">
                <?php echo $view->render(
                    'MauticEventBundle:Event:form_fields.html.php',
