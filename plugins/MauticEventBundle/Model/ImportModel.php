...
class ImportModel extends FormModel
{
        ...
        while ($batchSize && !$file->eof()) {
            ...
            if (!$errorMessage) {
                ...
                try {
                    ...
                    $this->dispatcher->dispatch(LeadEventPlugins::IMPORT_ON_PROCESS, $event);
    ...
    protected function dispatchEvent($action, &$entity, $isNew = false, EventDispatcher $event = null)
    {
        ...
        switch ($action) {
            case 'pre_save':
                $name = LeadEventPlugins::IMPORT_PRE_SAVE;
                break;
            case 'post_save':
                $name = LeadEventPlugins::IMPORT_POST_SAVE;
                break;
            case 'pre_delete':
                $name = LeadEventPlugins::IMPORT_PRE_DELETE;
                break;
            case 'post_delete':
                $name = LeadEventPlugins::IMPORT_POST_DELETE;
                break;
            case 'batch_processed':
                $name = LeadEventPlugins::IMPORT_BATCH_PROCESSED;
                break;
            default:
                return null;
        }
