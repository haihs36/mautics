...
class Lead extends FormEntity implements CustomFieldEntityInterface, IdentifierFieldEntityInterface
{
    ...
    public function __construct()
    {
        ...
        $this->eventChangeLog = new ArrayCollection();
    }
    ...
    public static function loadMetadata(ORM\ClassMetadata $metadata)
    {
        ...
        $builder->createOneToMany('eventChangeLog', 'EventChangeLog')
            ->orphanRemoval()
    ...
    /**
     * Get the secondary identifier for the lead; mainly event.
     *
     * @return string
     */
     ...
     * @param null $event
     */
    public function addEventChangeLogEntry($type, $name, $action, $event = null)
    {
        if (!$event) {
        ...
        // Create a new event change event
        $event = new EventChangeLog();
        $event->setType($type);
     ...
     * @return Lead
     */
    public function addEventChangeLog(EventChangeLog $eventChangeLog)
    {
