...
$header = ($entity->getId())
    ...
    $view['translator']->trans(
        'mautic.transaction.menu.edit',
        ['%name%' => $view->escape($entity->getName())]
    )
    :
    $view['translator']->trans('mautic.transaction.menu.new');
...
?>
    ...
    echo ' active';
                                ...
                                <a href="#transaction-<?php echo $g; ?>" class="steps" data-toggle="tab">
        ...
        <div class="col-md-9 bg-auto height-auto bdr-l">
            <div class="tab-content">
                <?php echo $view->render(
                    'MauticTransactionBundle:Transaction:form_fields.html.php',
